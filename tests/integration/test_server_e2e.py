...
# Load .env so GEMINI_API_KEY is available for the server subprocess
...
_has_api_key = bool(os.getenv("GEMINI_API_KEY") or os.getenv("GOOGLE_API_KEY"))
pytestmark = pytest.mark.skipif(not _has_api_key, reason="GEMINI_API_KEY not set — skipping E2E tests")
